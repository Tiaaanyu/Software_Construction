...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //final Set<String> mentionedUsers1 = Extract.getMentionedUsers1(tweets);
        System.err.println("covers " + mentionedUsers.size() + " Twitter users");
        //System.err.println("covers " + mentionedUsers1.size() + " Twitter users");
        //mentionedUsers.removeAll(mentionedUsers1);
        //for(String x: mentionedUsers)
       ...
       // System.out.println(followsGr/ySet().size());
