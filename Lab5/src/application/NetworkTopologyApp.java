...
public class NetworkTopologyApp {
	public static void main(String[] args) {
		NetworkTopologyFactory ntf = new NetworkTopologyFactory();
		...
		System.out.println("8. Write to files");
		...
		do {
			...
			case 1:
				...
				try {
					graph = ntf.createGraph(input.nextLine());
...
//											new CentralityContext().setCentralityStrategy("outdegreeCentrality", graph, v));
			...
			case 8:
				ntf.writeGraph("src/output.txt", graph);
			default:
