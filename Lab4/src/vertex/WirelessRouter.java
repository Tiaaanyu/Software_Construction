...
public class WirelessRouter extends Vertex{
	private final String vertexType = "WirelessRouter";
...
//	-IPAddress is a String which represents the IP address of the server.
...
//  -There's no method return the mutable.
	...
	public boolean equals(Object that) {
		...
		if(that instanceof WirelessRouter) {
			WirelessRouter other = (WirelessRouter) that;
